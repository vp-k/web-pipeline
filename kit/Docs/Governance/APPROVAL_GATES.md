...
- Approval of a design never grants review, a check exception, release readiness or production execution. Review/release need a fresh phase-specific response against the shown Full evidence. Exceptions require an exact check ID, reason and explicit user acceptance of that exception; they remain NOT_APPLICABLE, never PASS.
